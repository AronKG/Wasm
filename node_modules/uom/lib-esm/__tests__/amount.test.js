...
describe("amount_test", function () {
    ...
    test("Multiply_double_to_amount", function (done) {
        ...
        closeTo(valueLeft * valueRight, Amount.valueAs(BaseUnits.Kelvin, res1), 0.000001, done);
        done();
    });
    test("Divide_amount_by_double", function (done) {
        ...
        closeTo(valueLeft / valueRight, Amount.valueAs(BaseUnits.Kelvin, res1), 0.00001, done);
        done();
    });
