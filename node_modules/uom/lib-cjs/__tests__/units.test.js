...
describe("units_test_equals", function () {
    ...
    // });
    test("Base unit One should be equal. Order should not matter", function () {
        var unit = Serialize.unitToString(Unit.One);
        var unit2 = Serialize.unitToString(Unit.One);
    ...
    // });
    test("Product unit should be equal", function () {
        var unit = Unit.divide("u", "Length", BaseUnits.Meter, BaseUnits.Meter);
        var unit2 = Unit.divide("u", "Length", BaseUnits.Meter, BaseUnits.Meter);
        expect(Unit.equals(unit, unit2)).toBeTruthy();
    });
