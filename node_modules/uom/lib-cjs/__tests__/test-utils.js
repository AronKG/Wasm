...
//   return skips;
// }
function closeTo(actual, expected, delta, theTest, failMsg
// passMsg: string = "closeTo"
) {
    if (failMsg === void 0) { failMsg = "closeTo, expected: " + expected + ", actual: " + actual + ", delta: " + delta; }
    var actualDelta = Math.abs(actual - expected);
