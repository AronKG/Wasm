 ...
 */
export declare type UnitInfo<T> = AlternateUnit<T> | BaseUnit<T> | ProductUnit<T> | TransformedUnit<T>;
/**
 ...
 */
export declare function createBase<T>(name: string, quantity: T, symbol: string): Unit<T>;
/**
 ...
 */
export declare function createAlternate<T>(name: string, symbol: string, parent: Unit<T>): Unit<T>;
/**
 ...
 * @returns left * right
 */
export declare function times<T>(name: string, quantity: T, left: Unit<unknown>, right: Unit<unknown>): Unit<T>;
/**
 ...
 * @returns left / right
 */
export declare function divide<T>(name: string, quantity: T, left: Unit<unknown>, right: Unit<unknown>): Unit<T>;
export declare function squareRoot<T>(name: string, quantity: T, unit: Unit<unknown>): Unit<T>;
export declare function timesNumber<T>(name: string, factor: number, unit: Unit<T>): Unit<T>;
export declare function divideNumber<T>(name: string, factor: number, unit: Unit<T>): Unit<T>;
export declare function plus<T>(name: string, offset: number, unit: Unit<T>): Unit<T>;
export declare function minus<T>(name: string, offset: number, unit: Unit<T>): Unit<T>;
/**
 ...
 */
export declare function convert(value: number, fromUnit: Unit<unknown>, toUnit: Unit<unknown>): number;
export declare function equals(left: Unit<unknown>, right: Unit<unknown>): boolean;
export declare type GetSymbolFn = (unit: Unit<unknown>) => string;
export declare function buildDerivedSymbol<T>(unit: Unit<T>, getSymbol?: GetSymbolFn): string;
export declare function exhaustiveCheck(x: never, throwError?: boolean, match?: string): never;
